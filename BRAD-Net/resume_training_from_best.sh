...
# Resume training from the best epoch

# Features:
# 1. Resume from the best checkpoint
# 2. Use the optimized contrastive loss (lower threshold, higher temperature)
# 3. Continue remaining epochs

# Changes:
# - Contrastive threshold: 10 -> 3 (allow contrastive learning on small maps)
# - Sampling: boundary 512 -> 256, min 10 -> 3
# - Temperature: 0.07 -> 0.5 (more stable gradients)
